...
unsigned char key_map[] = {
    ...
    '9',
    '0',
    '+', // 扫描码0x02,...0x0c,0x0d 对应的ASCII 码，以下类似。
    127,
    9,
    'q',
    'w',
    ...
    0,
    0,
    /* 3A-49 */ /* 扫描码0x3A-0x49 对应的ASCII 码 */
    '-',
    0,
    0,
    0,
    '+',
    /* 4A-4E */ /* 扫描码0x4A-0x4E 对应的ASCII 码 */
    0,
    0,
    0,
    0,
...
unsigned char key_map[] = {0,
			   ...
			   '`',
			   0,
			   42, /* coin sup gauche, don't know, [*|mu] */
			   'w',
			   'x',
			   'c',
			   'v',
